...
public partial class ShippersDbContext : DbContext
{
    public ShippersDbContext()
    {
    }

    public ShippersDbContext(DbContextOptions<ShippersDbContext> options)
        : base(options)
    {
    }
    ...
    {
        return "Server=DESKTOP-USN74V6\\SQLEXPRESS;Database=ShippersDb;Trusted_Connection=True;TrustServerCertificate=True;";
    }
